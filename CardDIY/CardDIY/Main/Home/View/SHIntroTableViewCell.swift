...
class SHIntroTableViewCell: UITableViewCell {
    ...
    func initUI() {
        contentLabel = ({
            ...
            label.text = LocalizedString(key: "Hello and welcome. Hope you can make your own YuGiOh Card and have fun with it. Some features haven't been added yet, and will be added in the future. Thanks for purchasing!")
