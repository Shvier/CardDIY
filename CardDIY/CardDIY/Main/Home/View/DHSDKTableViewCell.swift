...
let DHSDKTableViewCellReuseIdentifier = "DHSDKTableViewCellReuseIdentifier"
...
// MARK: - Life Cycle
    ...
    func initUI() {
        ...
        sdkNameLabel = ({
            let label = UILabel()
            label.font = UIFont(name: WordFontFamily, size: kSDKNameLabelFontSize)
        ...
        authorNameLabel = ({
            let label = UILabel()
            label.font = UIFont(name: WordFontFamily, size: kAuthorNameLabelFontSize)
            label.textAlignment = .left
            label.preferredMaxLayoutWidth = ScreenWidth
